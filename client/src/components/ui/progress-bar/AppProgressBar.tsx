...
import { isSameURL, isSameURLWithoutSearch } from './sameURL';
import { usePathname, useSearchParams, useRouter as useNextRouter } from 'next/navigation';
import { ProgressBarProps, RouterNProgressOptions } from './index';
import { getAnchorProperty } from './getAnchorProperty';
  ...
  ({
    ...
    useEffect(() => {
      ...
      const handleAnchorClick = (event: MouseEvent) => {
        ...
        if (shallowRouting && isSameURLWithoutSearch(targetUrl, currentUrl) && disableSameURL)
          return;
